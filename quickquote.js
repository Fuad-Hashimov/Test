...
document.onreadystatechange = async function () {
  ...
  <div class="body-mask"></div>
    ...
    document.getElementById("quote-first-name").addEventListener("focus",() =>{
      console.log("click");
    } )

    function getProducts() {
      getProductsApi(1).then((resultProduct) => {
        for (let i = 1; i <= resultProduct.total_pages; i++) {
          let page = document.createElement("a");
          page.href = "#";
          page.dataset.id = i;
          page.classList.add("link");
          i == 1 ? page.classList.add("active") : "";
          page.innerText = i;
          document.getElementById("popup-pagination").appendChild(page);
        }
        document.getElementById("popup-product-list").innerHTML = `
  ...
  <div class="pop-up_content-box" id="prod-view-screen">
    ...
    <div class="pop-up_body">
      ...
      //         const productList =
      //           document.getElementById("popup-product-list");
      ...
      //#endregion
      //#region If css applied show body
