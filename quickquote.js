...
import catalogPopup from "./catalogPopup.js";
  ...
  <div class="body-mask"></div>
    ...
    async function getData() {
      if (firstRequest) {
        ...
        await getProducts(1, true).then((res) => {
          quickHtml();
          catalogPopup();
        });
        document
        ...
        if (isFirst) {
          ...
          while (pageCount < total_pages) {
            ...
            page.addEventListener("click", function () {
              const activePageC = document.querySelector("a.link.active");
              if (activePageC.dataset.id !== this.dataset.id) {
